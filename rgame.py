...
pygame.display.set_caption('@ERICK NDURUMO')
...
drawText('ERICK WELCOMES YOU... PRESS  ENTER TO START', font, windowSurface, (WINDOWWIDTH / 5) - 137, (WINDOWHEIGHT / 3) + 80)
...
while (count > 0):
    ...
    if (count == 0):
        drawText('OOOPS!!! UR CRUSHED', font, windowSurface, (WINDOWWIDTH / 3) + 40, (WINDOWHEIGHT / 3) + 70)
        drawText('PRESS ENTER KEY FOR A NEW GAME', font, windowSurface, (WINDOWWIDTH /3) - 110, (WINDOWHEIGHT / 3) + 95)
        pygame.display.update()
        time.sleep(2)
        waitForPlayerToPressKey()
        count = 3
